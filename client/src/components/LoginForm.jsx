  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex items-center justify-center p-6 sm:p-12 bg-white'>
        ...
        {error && (
          <div className='mb-6 p-4 bg-rose-50 border border-rose-200 text-rose-700 text-sm rounded-xl flext items-start gap-3'>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          <div>
            ...
            <input type='email' value={email} onChange={(e) => setEmail(e.target.value)} required placeholder='abhi@example.com' />
