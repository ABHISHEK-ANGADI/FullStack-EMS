                            ...
                            leaves.map((leave) => {
                                ...
                                return (
                                    <tr key={leave._id || leave.id}>
                                        ...
                                        <td>
                                            <span className='badge bg-slate-100 text-slate-800'>{leave.type}</span>
                                        ...
                                        <td>
                                            {leave.status === "PENDING" && (
                                                <div className='flex justify-center gap-2'>
                                                    ...
                                                    <button onClick={() => handleStatusUpdate(leave._id || leave.id , "REJECTED")} disabled={!!processing} className='p-1.5 rounde-md bg-rose-50 text-rose-600 hover:bg-rose-100 transition-color'>
