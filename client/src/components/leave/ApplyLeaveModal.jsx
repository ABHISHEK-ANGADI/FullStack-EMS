        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in' onClick={(e) => e.stopPropagation()}>
            ...
            <form className='p-6 space-y5'>
                ...
                <div>
                    ...
                    <textarea name='reason' required rows={3} className='resize-none' placeholder='Brief describe why you need this leave...' />
                </div>
                ...
                <div className='flex gap-3 pt-2'>
                    <button onClick={onClose} type='button' className='btn-secondary flex-1'>Cancel</button>
                     ...
                     <button onClick={handleSubmit} type='submit' disabled={loading}  className='btn-primary flex-1 flex items-center justify-center gap-2'>
